...
WindowName = "Inst.GuideRMS monitor"
...
def addWindow(tlSet):
    ...
    tlSet.createToplevel(
        ...
        visible = False,
        resizable = True,
        wdgFunc = GuideRMSMonitorWdg,
    )

class GuideRMSMonitorWdg(Tkinter.Frame):
    def __init__(self, master, timeRange=3600, width=8, height=2.4):
        """Create a GuideRMSMonitorWdg
        ...
        self.stripChartWdg.showY(0.0, 1.0, subplotInd=subplotInd)
        self.stripChartWdg.subplotArr[0].yaxis.set_label_text("guideRMS")
        self.stripChartWdg.addConstantLine(0.5, subplotInd=subplotInd, color="grey")
